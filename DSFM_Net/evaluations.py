...
def Sen_Pre(Sen, Pre):
    np.save('/root/My/CS_Net_master/only_for_vessel_seg/log/visual_results/DRIVE_4_FMA/recall.npy', Sen)
    np.save('/root/My/CS_Net_master/only_for_vessel_seg/log/visual_results/DRIVE_4_FMA/precision.npy', Pre)
...
def roc_pr_curve(y_true, y_scores, path_experiment):
    ...
    # np.save('/root/code/Vessel_Net/only_for_vessel_seg/log/visual_results/DRIVE_(UU_C_1)_13/fpr.npy', fpr)
    # np.save('/root/code/Vessel_Net/only_for_vessel_seg/log/visual_results/DRIVE_(UU_C_1)_13/tpr.npy', tpr)
    AUC_ROC = auc(fpr, tpr)
    ...
    # np.save('/root/code/Vessel_Net/only_for_vessel_seg/log/visual_results/DRIVE_(UU_C_1)_13/precision.npy', precision)
    # np.save('/root/code/Vessel_Net/only_for_vessel_seg/log/visual_results/DRIVE_(UU_C_1)_13/recall.npy', recall)
